...
export default {
  ...
  computed: {
    showNFTSLink() {
      return this.$auth.user != null && (this.$auth.user.ethAccount != null || this.$auth.user.tezosAccount != null || this.$auth.user.polkadotAccount != null || this.$auth.user.polkadotEvmAccount != null|| this.$auth.user.nearAccount != null)
    },
    defaultChain() {
