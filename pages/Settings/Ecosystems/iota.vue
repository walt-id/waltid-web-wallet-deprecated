    ...
    <div class="_setting">
        ...
        <div class="d-flex align-items-center justify-content-center _wizard mt-3">
            ...
            <div :class="this.wizardIndex === 1 ? '_left-fade': 'hide'">
                <div class="_item">
                    <h4>Step 2</h4>
                    <p>Generate a DID on Tangle architecture.</p>
                </div>
                <div class="mt-3 d-flex _button-view justify-content-center">
                    <div>
            ...
            <div :class="this.wizardIndex === 2 ? '_fadin': 'hide'">
                <div class="_item">
                    ...
                    <p>did:iota generated successfully</p>
                </div>
            </div>
...
import BlockingButtonComponent from '~/components/BlockingButtonComponent'
