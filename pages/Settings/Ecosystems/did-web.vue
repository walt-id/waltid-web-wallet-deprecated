                ...
                <div id="content" class="_setting">
                    ...
                    <div class="d-flex align-items-center justify-content-center _wizard mt-3">
                        <div :class="this.wizardIndex === 0 ? '': 'animate__fadeOutRight hide'">
                            <div class="_item">
                              <h4>Step 1</h4>
                              <p>Make sure you have access to the web-space of the domain where you want to host your did:web.</p>
                            </div>
                        ...
                        <div :class="this.wizardIndex === 1 ? '_left-fade': 'hide'">
                            <div class="_item">
                              <h4>Step 2</h4>
                              <p>Enter domain name (without "https://")</p>
                            </div>
                            <div class="mt-3 d-flex _button-view justify-content-center">
                                <div>
                                    <form action="" id="token-submit" @submit.prevent="tokenSubmit">
                                        <input placeholder="example.com" id="inserted-domain-name" name="insertDomainName" :class="this.tokenWrong===true ? 'form-control my-2 border-danger':'form-control my-2'" :data="this.domainName" v-model="domainName"/>
                        ...
                        <div :class="this.tokenSubmitted === true ? '_fadin': 'hide'">
                            <div class="_item">
                              ...
                              <p>You just successfully onboarded did:web</p>
                            </div>
                        </div>
                    </div>
                    <p :class="this.wizardIndex === 2 ? 'hide': '_help'">For more information regarding Decentralized Identifiers visit <span><a href="https://docs.walt.id" target="_blank">docs.walt.id</a></span></p>
                </div>
